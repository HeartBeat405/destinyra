    ...
    <main className="flex min-h-screen items-center justify-center bg-canvas px-6">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted">Administrator sign in</p>
        </div>
        ...
        >
          {!isSupabaseConfigured && (
            <div className="mb-6 rounded-2xl border border-warning/20 bg-warning/10 p-4 text-sm text-[#92400e]">
              Authentication is not configured yet. Add your Supabase
              credentials to <code>.env.local</code> to enable admin sign in.
            </div>
          )}
